...
def dataloader0(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/home/disk3/zhousiyu/dataset/CACD2000/data/0/', transform=transform)
...
def dataloader1(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/home/disk3/zhousiyu/dataset/CACD2000/data/1/', transform=transform)
...
def dataloader2(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/home/disk3/zhousiyu/dataset/CACD2000/data/2/', transform=transform)
...
def dataloader3(input_size, batch_size, split='train'):
    ...
    dataset = datasets.ImageFolder(root='/home/disk3/zhousiyu/dataset/CACD2000/data/3/', transform=transform)
